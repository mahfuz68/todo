    ...
    return (
        <div>
            <div className="text-center pt-3 dark:text-white dark:bg-gray-900">
                <div className="sm:px-4  md:px-14 xl:px-36 flex justify-between items-center">
                    <div className="flex space-x-4 lg:space-x-6 items-center">
                        ...
                        <NavLink
                            to="/login"
                            className="invisible md:visible font-medium rounded-lg px-4 py-1 border-white hover:border-gray-600 dark:border-gray-900 border-2 dark:hover:border-indigo-700"
                        >
                            Features
                        </NavLink>
                    </div>
                    <div className="flex items-center space-x-2 md:space-x-2 font-extrabold">
                        <NavLink
